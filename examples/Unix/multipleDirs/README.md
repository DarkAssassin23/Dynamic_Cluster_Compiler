...
## About
This is a multi-threaded TCP server, written in C, that listens for connections and 
replies back with how much time is left based on the date provided in its config 
file.

This is a modified version of my 
<a href="https://github.com/DarkAssassin23/Universal-Countdown">
Universal Countdown server</a> to contain more nesting
of folders to show how you can use the distributed compiler with a project that has
