# Hello World Example Using a Unix Based Cluster

About
---------
This is a basic exmaple which uses a few source files and a couple
of nodes running a Unix based OS (ex. a cluster of Linux nodes or macOS nodes)
