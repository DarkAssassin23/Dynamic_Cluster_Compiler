...
Vehicular Cloud Simulation</a> to work with the distributed compiler
...
off your $PATH
```bash
cd /mnt/Code/Distributed-Compiler/examples/Java_Example
python3 dcc.py
```
...
```bash
dcc ~/shared/Distributed-Compiler/examples/Java_Example
```
